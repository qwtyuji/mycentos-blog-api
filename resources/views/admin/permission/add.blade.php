        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" permission="form" method="POST" action="{{ route('permission.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('cname') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="cname" type="text" class="form-control" name="cname" value="{{ old('cname') }}" autofocus
                                       placeholder="如:角色列表">
